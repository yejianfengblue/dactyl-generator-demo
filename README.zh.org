...
- [[#connectors-连接头-1][Connectors 连接头]]
  - [[#external-holder-外置芯片支架][External Holder 外置芯片支架]]
  - [[#connector-连接头类型][Connector 连接头类型]]
  - [[#usb-hole-usb孔][USB hole USB孔]]
...
** Connectors 连接头
   - use loligagger's external holder 外置芯片支架: no 否
   - connector 连接头类型: none 无. 详见 [[Known Issues 已知问题][已知问题]] #1
   - USB hole USB孔: 暂时省略. 详见 [[Known Issues 已知问题][已知问题]] #1
...
** Form of the case 键盘外形
   ...
   - top right, top left, middle left 自定义拇指区按键
...
** Connector 连接头类型
   暂时省略。详见[[Known Issues 已知问题][已知问题]] #1
