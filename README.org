...
In section ~curvature & tenting~, you can think PI/180 is equal to 1 degree.
For example, PI/6 is equal to 30 degree.

In section ~form of the case~, the measurement unit is millimeter.
...
PI/180 is equal to 1 degree. PI/6 is equal to 30 degree.
...
The measurement unit is millimeter.
