...
On 2022-06-23, the [[https://dactyl.siskam.link][Dactyl Generator]] website was reported to be down.
[[https://github.com/ibnuda/dactyl-keyboard/issues/116][An Github issue]] was created to notify the website Author [[https://github.com/ibnuda/dactyl-keyboard/issues/116][Ibnu Daru Aji]].
One workaround is following the [[https://github.com/ibnuda/dactyl-keyboard#development][steps]] to run the website on your own computer.
If someone generous provides a server to run this website, [[https://github.com/yejianfengblue/dactyl-generator-demo/issues/new][create an issue]] to contact me.
...
parameters work by generating models and preview images using [[https://dactyl.siskam.link/api][Dactyl Generator API]].
...
* Credit
  - [[https://dactyl.siskam.link][Dactyl Generator]] goes to [[https://github.com/ibnuda/dactyl-keyboard][ibnuda]]
